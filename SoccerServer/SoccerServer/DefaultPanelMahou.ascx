<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DefaultPanelMahou.ascx.cs" Inherits="SoccerServer.DefaultPanelMahou" %>

<div id="fb-root"></div>
				
<div style="margin-bottom:10px;width:760px;height:74px;"><img src="Imgs/MainHeader.jpg" alt= "" width="760" height="74" style="display:block;border:0;"></img></div>
