		...
		static public const PUBLISH_MESSAGE_EXAMPLE : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/Logo100x100.png",
				daUserMessagePrompt: ""
			}
		...
		static public const PUBLISH_MESSAGE_PARTIDOGANADO : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeVictoria.jpg",
		...
		static public const PUBLISH_MESSAGE_SUPERPOTENCIA : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadSuperpotencia.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}			
		...
		static public const PUBLISH_MESSAGE_FURIAROJA : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadFuriaRoja.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
		...
		static public const PUBLISH_MESSAGE_CATENACCIO : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadCatenaccio.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
		...
		static public const PUBLISH_MESSAGE_TIROAGOL : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadTiroAGol.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
		...
		static public const PUBLISH_MESSAGE_TIEMPOEXTRA : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadTiempoExtra.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
		...
		static public const PUBLISH_MESSAGE_TIROEXTRA : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadTiroExtra.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
		...
		static public const PUBLISH_MESSAGE_5ESTRELLAS : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidad5Estrellas.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
		...
		static public const PUBLISH_MESSAGE_VERAREAS : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadVerAreas.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
		...
		static public const PUBLISH_MESSAGE_MANODEDIOS : Object =
			{
				...
				daImgSrc: AppConfig.CLIENT_URL + "/Imgs/MensajeHabilidadManoDeDios.jpg",
				daUserMessagePrompt: "Mahou Liga Chapas: el juego definitivo de fútbol"
			}
