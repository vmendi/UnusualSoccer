package Caps
{
	...
	public class Game
	{
		...
		{
			VerifyStateWhenReceivingCommand(GameState.WaitingForTimeout, idPlayer, "OnClientTimeout");
		...
		// 
		// Entrada desde el servidor de finalización de una de las mitades del partido
