...
namespace Exitgames.Realtime.Policy.Application
{
    ...
    public class Policy : IPhotonApplication, IPhotonApplicationControl
    {
        ...
        #region IPhotonApplicationControl
        ...
        public void OnPhotonRunning()
        {
            ...
            {
                log.Info("Application start. AppId: " + this.applicationId + " ApplicationPath: " + this.applicationPath);
            }

            try
            {
                this.policyBytesUtf8 = ReadPolicyFile(Path.Combine(this.applicationPath, "assets/socket-policy.xml"));
                this.silverlightPolicyBytesUtf8 = ReadPolicyFile(Path.Combine(this.applicationPath, "assets/socket-policy-silverlight.xml"));
            }
            catch (Exception e)
            {
                log.Error(e);
